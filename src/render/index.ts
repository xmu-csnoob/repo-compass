...
export function renderRepoMap(contextIndex: ContextIndex): string {
  const lines = [
    ...
    `- Structural shape (coarse): \`${contextIndex.repo.repo_shape}\``,
...
<body>
  <header>
    <div class="container">
      ...
      <div class="subtitle">Structural repo map &middot; Generated by Repo Compass</div>
    </div>
  </header>
